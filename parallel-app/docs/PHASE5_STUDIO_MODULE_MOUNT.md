...
Tapping `STUDIO` in the main app dock switches to the Studio module in place. Studio no longer behaves like a separate product entry from the main app shell.
